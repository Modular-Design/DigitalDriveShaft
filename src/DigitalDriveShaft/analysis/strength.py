...
def calc_strength(shaft: DriveShaft, load: Loading):
    ...
    d_center_stackup = shaft_radius + (0.5 - shaft.get_contour_factor()) * laminat_thickness
    u_shaft = np.pi * d_center_stackup

    nx = load.fx/u_shaft    #N/mm
    ny = 0                  #N/mm   # TODO: @Alrik bitte Formel ergänzen
    nxy = load.mx/d_center_stackup/2/u_shaft     #N/mm #ggf. Ergänzung von Fy und Fz komponenten
    mx = 0                  #N      # TODO: @Alrik bitte Formel ergänzen
    my = np.sqrt((load.my/1000/d_center_stackup/2)**2 + (load.mz/1000/d_center_stackup/2)**2)     #N
    mxy = 0                         # TODO: @Alrik bitte Formel ergänzen
